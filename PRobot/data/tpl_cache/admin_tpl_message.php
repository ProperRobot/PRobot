<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/message|admin/tpl/header|admin/tpl/footer|template/default/header|template/default/footer', '1365987874', 'admin/tpl/message');?><?php $_TPL['menunames'] = array(
		'index' => '管理首頁',
		'config' => '站點設置',
		'privacy' => '隱私設置',
		'usergroup' => '用戶組',
...
&nbsp; <?php if($url_forward) { ?><a href="<?=$url_forward?>">確定</a> &nbsp; <?php } ?><a href="javascript:history.back(-1)">返回上一頁</a> &nbsp; <a href="admincp.php">管理首頁</a>
</div>
